...
public class UfoScript : MonoBehaviour
{
 ...
 // private GameObject distanceTextObject;
  ...
  IEnumerator GetCoordinates_Ufo()
  {
      ...
      if (Input.location.status == LocationServiceStatus.Failed) {
        ...
        if (setOriginalValues) {
         ...
         // originalLongitude = Input.location.lastData.longitude;
                    originalLatitude = 48.998389f;
                    originalLongitude = 12.105032f;
        ...
        currentLongitude = Input.location.lastData.longitude;
                //, 12.105032
               // currentLatitude = 48.998389f;
               // currentLongitude = 12.105032f;



        //calculate the distance between where the player was when the app started and where they are now.
        Calc_Ufo (originalLatitude, originalLongitude, currentLatitude, currentLongitude);
  ...
  public void Calc_Ufo(float lat1, float lon1, float lat2, float lon2)
  {
  ...
  void Start(){
    ...
    StartCoroutine ("GetCoordinates_Ufo");
